...
<body class="flex">
    ...
    <aside
        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            <nav>
                <a class="flex items-center px-4 py-2 text-gray-700 bg-gray-100 rounded-lg dark:bg-black dark:text-gray-200"
                    href="#">
    ...
    <main class="w-full bg-gray-200 h-screen text-black">
        ...
        <!-- PROFILE SECTION -->
        <section class=" flex justify-center mt-16" id="admin-profile">
        ...
        <section>
            ...
            <div class="hidden mx-5 text-[10px] h-[70vh] overflow-auto">
