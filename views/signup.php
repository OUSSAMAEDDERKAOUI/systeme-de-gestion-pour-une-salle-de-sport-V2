    ...
    <header class="text-white">
        ...
        <nav class="bg-black flex px-20 justify-between items-center py-5">
            ...
            <ul class="flex gap-10  items-center">
                ...
                <a href="./login.php"><button type="submit" class="border border-white rounded-md py-1 px-5 text-lg font-medium transition-all duration-500 hover:bg-orange-500 hover:text-black hover:scale-105 hover:border-none">LOGIN</button></a>
            </div>
        </nav>
    </header>

    <main class="main py-20 flex text-white items-center justify-center">
        <section class="flex flex-col gap-2 bg-black w-[35vw] p-8 rounded-md shadow-sm shadow-orange-500">
            ...
            <form method="POST" action="../classes/functions/signup.php" class="flex flex-col gap-3">
                ...
                <button name="signup" class="py-1 px-4 bg-orange-500 text-black font-medium mt-5">SIGN UP</button>
            </form>
        </section>
    </main>
